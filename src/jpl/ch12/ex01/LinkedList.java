...
public class LinkedList {
    ...
    /* nullを返すのはよくない。
    　上位で正しくnullチェックするかは不明であり、さらに上位でキャッチすることもできないため。*/
    public LinkedList find(Object data) throws ObjectNotFoundExeption {

        LinkedList nowList = this;

        while(nowList != null) {
            if(nowList.data.equals( data )) {
                return nowList;
            }
            nowList = nowList.next;
        }
        throw new ObjectNotFoundExeption(data);
    }
