...
public class ClockPanel extends JPanel implements MouseMotionListener, MouseListener {
	...
	public ClockPanel(ClockFrame frame)  {
		this.frame = frame;
		menu = new Property(frame, this);
	...
	public void mouseDragged(MouseEvent e) {
		frame.setLocation(e.getXOnScreen() - xOnApli, e.getYOnScreen() - yOnApli);
	}
	...
	public void mousePressed(MouseEvent e) {
		xOnApli = e.getXOnScreen() - frame.getX();
		yOnApli = e.getYOnScreen() - frame.getY();
	}
